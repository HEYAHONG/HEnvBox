...
//hsoftplc.c
    ...
    {hdefaults_str(hsoftplc_dll_load),(uintptr_t)&hsoftplc_dll_load},
    {hdefaults_str(hsoftplc_dll_unload),(uintptr_t)&hsoftplc_dll_unload},
    {hdefaults_str(hsoftplc_database_key_get_from_variable_name),(uintptr_t)&hsoftplc_database_key_get_from_variable_name},
    {hdefaults_str(hsoftplc_database_get_value),(uintptr_t)&hsoftplc_database_get_value},
    {hdefaults_str(hsoftplc_database_set_value),(uintptr_t)&hsoftplc_database_set_value},
    {hdefaults_str(hsoftplc_database_value_cache_init),(uintptr_t)&hsoftplc_database_value_cache_init},
    {hdefaults_str(hsoftplc_database_value_cache_update),(uintptr_t)&hsoftplc_database_value_cache_update},
//huuid.c
